                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                <div class="overflow-hidden flex-nowrap">
                                                    <h6 class="mb-1">
                                                        <a href="{{ route('login') }}" class="text-reset">User Panel</a>
                                                    </h6>
                                    ...
                                    <div class="card mb-3 card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                <div class="overflow-hidden flex-nowrap">
                                                    <h6 class="mb-1">
                                                        <a href="{{ route('admin.login') }}" class="text-reset">Admin Panel</a>
                                                    </h6>
                                                    <span class="text-muted d-block mb-2 small">
                                    ...
                                    <div class="card mb-3 card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                <div class="overflow-hidden flex-nowrap">
                                                    <h6 class="mb-1">
                                                        <a href="{{ route('manager.login') }}" class="text-reset">Manager Panel</a>
                                                    </h6>
                                                    <span class="text-muted d-block mb-2 small">
                                    ...
                                    <div class="card mb-3 card-body">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col">
                                                <div class="overflow-hidden flex-nowrap">
                                                    <h6 class="mb-1">
                                                        <a href="#!" class="text-reset">Guest Panel</a>
                                                    </h6>
                                                    <span class="text-muted d-block mb-2 small">
